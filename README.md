...
## 💻 Materials
<p align="justify"> 
All the code necessary to replicate our work is available in this repository. The datasets are available via <a href="https://data.mendeley.com/drafts/x6gty88k4f" target="_blank">Mendeley data</a> . For the Nvidia Jetson Nano, we used the docker image available at <a href="https://docs.ultralytics.com/es/guides/nvidia-jetson/#quick-start-with-docker" target="_blank">Ultralytics</a>.
</p>
